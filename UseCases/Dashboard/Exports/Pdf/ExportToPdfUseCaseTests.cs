...
namespace UseCases.Dashboard.Exports.Pdf
{
    public class ExportToPdfUseCaseTests
    {
        [Fact]
        public async Task Execute_Should_Return_Pdf_File_With_All_Reservations_When_No_Date_Filter()
        {
            // Arrange
            ...
            var useCase = new ExportToPdfUseCase(reservationRepositoryMock.Object);
        ...
        [Fact]
        public async Task Execute_Should_Return_Pdf_File_With_Filtered_Reservations_When_Date_Range_Provided()
        {
            // Arrange
            var reservationRepositoryMock = new Mock<IReservationRepository>();
        ...
        [Fact]
        public async Task Execute_Should_Return_Pdf_File_When_No_Reservations_Exist()
        {
            // Arrange
            var reservationRepositoryMock = new Mock<IReservationRepository>();
        ...
        public async Task Execute_Should_Handle_Large_Dataset()
        {
            ...
            for (int i = 1; i <= 100; i++) // Menor que Excel para evitar PDFs muito grandes nos testes
            {
        ...
        [Fact]
        public async Task Execute_Should_Include_Date_Period_In_Report_When_Dates_Provided()
        {
            // Arrange
            var reservationRepositoryMock = new Mock<IReservationRepository>();
        ...
        [Fact]
        public async Task Execute_Should_Handle_Reservations_With_Various_Currency_Values()
        {
            // Arrange
            var reservationRepositoryMock = new Mock<IReservationRepository>();
